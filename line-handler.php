...
- **業務実行が必要なすべての指示**（案件登録・見積作成・請求書作成・発注書作成・設計・スケジュール設定・外注手配など）
  ...
  → prompt には以下の形式で書く:
    ...
    - URLはLINEに送らない。PDFはかならずファイルとして送る:
      1. python lineworks_send.py --generate-pdf \"[PDF URL]\" \"C:\\temp\\doc_[id].pdf\"
      2. python lineworks_send.py \"AI事業\" \"C:\\temp\\doc_[id].pdf\" --file --headless
      3. Remove-Item \"C:\\temp\\doc_[id].pdf\"
